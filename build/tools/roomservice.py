...
custom_dependencies = "afterlife.dependencies"
org_manifest = "afterlife-devices"  # leave empty if org is provided in manifest
org_display = "AFTERLIFE-Devices"  # needed for displaying
